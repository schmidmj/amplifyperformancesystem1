    ...
    <header className="w-full border-b border-neutral-800/60 bg-neutral-950/70 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-neutral-300">
          <a className="hover:text-white transition" href="/athletes">Athletes</a>
          <a className="hover:text-white transition" href="/coaches">Coaches</a>
          <a className="hover:text-white transition" href="/facility">Facility</a>
          <a className="hover:text-white transition" href="/our-story">Our Story</a>
          <a className="hover:text-white transition" href="/contact">Connect</a>
        </nav>
